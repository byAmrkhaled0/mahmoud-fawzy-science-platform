...
window.forceFirestoreSync=async function(){try{persist(); await window.MFCloud?.saveSiteData?.(adminData); aToast('تم حفظ جميع التغييرات');}catch(e){aToast('تعذر حفظ التغييرات. تحقق من الإنترنت وحاول مرة أخرى.');}};
